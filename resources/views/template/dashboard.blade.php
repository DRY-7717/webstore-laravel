        ...
        <div class="d-flex" id="wrapper" data-aos="fade-right">
            ...
            <div class="border-right" id="sidebar-wrapper">
                ...
                <div class="list-group list-group-flush">
                    ...
                    <a href="dashboard.html" class="list-group-item list-group-item-action">My Product</a>
                    <a href="dashboard-transactions.html" class="list-group-item list-group-item-action">Transaction</a>
                    <a href="dashboard.html" class="list-group-item list-group-item-action">Store Settings</a>
                    <a href="dashboard.html" class="list-group-item list-group-item-action">My Account</a>
